                ...
                <div class="p-3 bg-white rounded">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="billed"><span class="font-weight-bold">Nama Sekolah: </span><span class="ml-1">Sekolah
                                    Alam Indramayu</span></div>
                                ...
                                <tbody>
                                    @foreach ($tagihan as $item)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($item->tanggal_tagihan)->locale('id')->translatedFormat('F Y') }}
                                            </td>
                                            <td>
                                                <ul>
